...
let%expect_test "min sequence" =
  ...
  [%expect
    ...
    ; (2,
       ...
       ; expected_bits_gained = 3.409556210179038
       ; expected_bits_remaining = 9.3779382895209622
       ; min_bits_gained = 2.4487581170999988
       ...
       ; by_cue =
           [ { cue = { white = 2; black = 0 }
             ...
             ; bits_gained = 2.4487581170999988
    ...
    ; (3,
       ...
       ; expected_bits_gained = 3.6487586980368336
       ; expected_bits_remaining = 6.6899776845631669
       ; min_bits_gained = 2.7166845631000003
       ; max_bits_gained = 10.3387363826
       ; max_bits_remaining = 7.6220518195
       ; by_cue =
           [ { cue = { white = 1; black = 1 }
             ; size_remaining = 197
             ; bits_remaining = 7.6220518195
             ; bits_gained = 2.7166845631000003
    ...
    ; (4,
       ...
       ; expected_bits_gained = 3.7846616828253823
       ; expected_bits_remaining = 3.8373901366746179
       ; min_bits_gained = 2.8671643173000003
       ; max_bits_gained = 7.6220518195
       ; max_bits_remaining = 4.7548875022
       ; by_cue =
           [ { cue = { white = 1; black = 1 }
             ; size_remaining = 27
             ; bits_remaining = 4.7548875022
             ; bits_gained = 2.8671643173000003
    ...
    ; (5,
       ...
       ; expected_bits_gained = 3.661932872414813
       ; expected_bits_remaining = 1.0929546297851869
       ; min_bits_gained = 2.7548875022
       ; max_bits_gained = 4.7548875022
       ; max_bits_remaining = 2
       ; by_cue =
           [ { cue = { white = 1; black = 0 }
             ; size_remaining = 4
             ; bits_remaining = 2
             ; bits_gained = 2.7548875022
