     ...
     (by_cue
      (((cue ((white 2) (black 0))) (size_remaining 7070)
       ...
       ((cue ((white 3) (black 0))) (size_remaining 5610)
        ...
        (probability 0.17120361328125) (next_best_guesses Not_computed))
       ((cue ((white 1) (black 1))) (size_remaining 4880)
        (bits_remaining 12.252665432450248) (bits_gained 2.7473345675497516)
        (probability 0.14892578125) (next_best_guesses Not_computed))
...
let%expect_test "color present 2 times" =
  ...
  [%expect
    ...
    ((candidate (Green Green Orange White Red))
     ...
     (min_bits_gained 2.2163878347439621) (max_bits_gained 15)
     (max_bits_remaining 12.783612165256038)
     (by_cue
      (((cue ((white 2) (black 0))) (size_remaining 7051)
        (bits_remaining 12.783612165256038) (bits_gained 2.2163878347439621)
        (probability 0.215179443359375) (next_best_guesses Not_computed))
       ((cue ((white 1) (black 1))) (size_remaining 5432)
        (bits_remaining 12.407267764244732) (bits_gained 2.5927322357552676)
        (probability 0.165771484375) (next_best_guesses Not_computed))
       ((cue ((white 1) (black 0))) (size_remaining 5196)
        (bits_remaining 12.343185715447881) (bits_gained 2.6568142845521194)
        (probability 0.1585693359375) (next_best_guesses Not_computed))
       ((cue ((white 2) (black 1))) (size_remaining 3510)
        (bits_remaining 11.777255315191923) (bits_gained 3.2227446848080774)
        (probability 0.10711669921875) (next_best_guesses Not_computed))
       ((cue ((white 3) (black 0))) (size_remaining 3095)
        (bits_remaining 11.595723694101627) (bits_gained 3.4042763058983727)
        (probability 0.094451904296875) (next_best_guesses Not_computed))
       ((cue ((white 0) (black 1))) (size_remaining 2387)
        (bits_remaining 11.220982851081777) (bits_gained 3.7790171489182232)
        (probability 0.072845458984375) (next_best_guesses Not_computed))
       ((cue ((white 0) (black 2))) (size_remaining 1523)
        (bits_remaining 10.572700226487292) (bits_gained 4.4272997735127078)
        (probability 0.046478271484375) (next_best_guesses Not_computed))
       ((cue ((white 1) (black 2))) (size_remaining 1497)
        (bits_remaining 10.547858506058416) (bits_gained 4.4521414939415838)
        (probability 0.045684814453125) (next_best_guesses Not_computed))
       ((cue ((white 0) (black 0))) (size_remaining 1024) (bits_remaining 10)
        (bits_gained 5) (probability 0.03125) (next_best_guesses Not_computed))
       ((cue ((white 3) (black 1))) (size_remaining 652)
        (bits_remaining 9.3487281542310772) (bits_gained 5.6512718457689228)
        (probability 0.0198974609375) (next_best_guesses Not_computed))
       ((cue ((white 4) (black 0))) (size_remaining 429)
        (bits_remaining 8.7448338374995451) (bits_gained 6.2551661625004549)
        (probability 0.013092041015625) (next_best_guesses Not_computed))
       ((cue ((white 2) (black 2))) (size_remaining 396)
        (bits_remaining 8.62935662007961) (bits_gained 6.37064337992039)
        (probability 0.0120849609375) (next_best_guesses Not_computed))
       ((cue ((white 0) (black 3))) (size_remaining 373)
        (bits_remaining 8.5430318202552371) (bits_gained 6.4569681797447629)
        (probability 0.011383056640625) (next_best_guesses Not_computed))
       ((cue ((white 1) (black 3))) (size_remaining 108)
        (bits_remaining 6.7548875021634682) (bits_gained 8.2451124978365318)
        (probability 0.0032958984375) (next_best_guesses Not_computed))
       ((cue ((white 0) (black 4))) (size_remaining 35)
        (bits_remaining 5.1292830169449664) (bits_gained 9.8707169830550328)
        (probability 0.001068115234375) (next_best_guesses Not_computed))
       ((cue ((white 4) (black 1))) (size_remaining 24)
        (bits_remaining 4.5849625007211561) (bits_gained 10.415037499278844)
        (probability 0.000732421875) (next_best_guesses Not_computed))
       ((cue ((white 3) (black 2))) (size_remaining 14)
        (bits_remaining 3.8073549220576042) (bits_gained 11.192645077942396)
        (probability 0.00042724609375) (next_best_guesses Not_computed))
       ((cue ((white 5) (black 0))) (size_remaining 12)
        (bits_remaining 3.5849625007211561) (bits_gained 11.415037499278844)
        (probability 0.0003662109375) (next_best_guesses Not_computed))
       ((cue ((white 2) (black 3))) (size_remaining 9)
        (bits_remaining 3.1699250014423122) (bits_gained 11.830074998557688)
        (probability 0.000274658203125) (next_best_guesses Not_computed))
       ((cue ((white 0) (black 5))) (size_remaining 1) (bits_remaining 0)
        (bits_gained 15) (probability 3.0517578125E-05)
        (next_best_guesses Not_computed))))) |}];
  let guess2 =
